...
while screen == "newGame":
    ...
    if ending == "win":
        ...
        if newHighscore:
            newhighscoretext = Text(Point(250, 400), "New highscore!")
            newhighscoretext.setFill("lightblue")
            newhighscoretext.setSize(30)
            newhighscoretext.draw(winScreen)
            newhighscoreRect = Rectangle(Point(100, 370), Point(400, 435))
            newhighscoreRect.setOutline("lightblue")
            newhighscoreRect.setWidth(10)
            newhighscoreRect.draw(winScreen)
            newHighscore = False
    ...
    highscoreimg = Image(Point(300, 525), "images/highscore.gif")
    ...
    while screen == "title":
        ...
        if 385 >= click.getX() >= 215 and 240 >= click.getY() >= 220:  # if user clicks on classic
                ...
                while placing:
                    ...
                    while time.time() < timeEnd:  # time for input
                        ...
                        if key == hotkey:
                            ...
                            if (
                                    prevPosition - position >= size * 2 or position - prevPosition >= size * 2) and addBlock is False:
                                ...
                                if (n == 0 or n == 1) and (
                                        position + 76 == prevPosition or position - 76 == prevPosition):
                                    n = n + 1
                                    block = blocks[n]
                                    size = sizes[n]
                                    drawnblock.undraw()
                            ...
                            if (level == 10 or (
                                    level - 10) % 9 == 0 and not level == 1) and endless:  # if it hits the top block
            ...
            hotkeyBackground = Image(Point(250, 250), "images/hotkeyBackground.gif")
            ...
            changeKey = Image(Point(250, 275), "images/hotkeyText1.gif")
            changeKey.draw(hotkeyScreen)

            confirmChange = Image(Point(250, 325), "images/hotkeyText2.gif")
            confirmChange.draw(hotkeyScreen)
            while screen == "hotkey fix":
                click = hotkeyScreen.getMouse()
                if 395 >= click.getX() >= 105 and 292 >= click.getY() >= 258:
                    changeKey.undraw()
                    selectKey = Image(Point(250, 275), "images/hotkeyText3.gif")
                    ...
                    if hotkey == "1" or hotkey == "2" or hotkey == "3":  # invalid hotkeys
                        hotkey = "space"
                        for i in range(3):
                            errorText = Text(Point(350, 450), "Hotkeys cannot be 1, 2, or 3!")
                            errorText.setSize(10)
            ...
            rulesscreenBackground = Image(Point(250, 250), "images/rulesBackground.gif")
        ...
        elif 10 <= click.getX() <= 90 and 535 <= click.getY() <= 565:  # if user clicks about
            aboutScreen = GraphWin("About", 500, 500)

            aboutscreenBackground = Image(Point(250, 250), "images/aboutBackground.gif")
            ...
            eggText = Image(Point(50, 450), "images/eastereggsmall.gif")
            ...
            if easteregg:
                ...
                egg = Image(Point(200, 110), "images/easteregg.gif")
                egg.draw(easterwin)

                smiley1 = Image(Point(75, 350), "images/smiley.gif")
                smiley2 = Image(Point(325, 350), "images/smiley.gif")
